...
public class solution3508 {
    public static void main(String[] args) {
        ...
        System.out.println(router.addPacket(1, 100, 10)); // true
        System.out.println(router.addPacket(2, 200, 20)); // true
        System.out.println(router.addPacket(1, 100, 10)); // false (duplicate)

        System.out.println(router.forwardPacket()); // [1,100,10]
        System.out.println(router.getCount(200, 15, 25)); // 1
    }
}
